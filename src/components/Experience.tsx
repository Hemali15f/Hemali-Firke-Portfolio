...
export default function Experience() {
  const experiences = [
    ...
    },
    {
      ...
      description:
        'Worked on various projects to gain practical experience in modern technologies and frameworks.',
      achievements: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            My journey of learning, building, and growing in the field of
            technology.
          </p>
        </div>
        ...
        <div className="relative">
          ...
          <div className="block md:hidden absolute left-4 h-full w-0.5 bg-gradient-to-b from-violet-700 via-blue-500 to-cyan-200"></div>

          <div className="space-y-12">
            {experiences.map((exp, index) => (
              <div key={index} className="relative">
                {/* Center Dot (Desktop Only) */}
                <div className="hidden md:flex shadow-[0_0_10px_#8b5cf6,0_0_8px_#22d3ee] absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-blue-600 rounded-full border-4 border-white dark:border-gray-800 z-10"></div>

                {/* Left Dot (Mobile Only) */}
                <div className="md:hidden shadow-[0_0_10px_#8b5cf6,0_0_8px_#22d3ee] absolute left-3.5 top-3 w-3.5 h-3.5 bg-blue-600 rounded-full border-4 border-white dark:border-gray-800 z-10"></div>
                ...
                >
                  <div
                    className={`shadow-[0_0_10px_#8b5cf6,0_0_8px_#22d3ee] ${
                      index % 2 !== 0 ? 'md:text-left md:col-start-2' : ''
                    }`}
                  >
