...
export default function Hero() {
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 relative overflow-hidden"
    >
      {/* Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-blue-200 dark:bg-blue-600/20 rounded-full animate-pulse"></div>
        <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-emerald-100 dark:bg-emerald-600/20 rounded-full animate-pulse delay-1000"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center">
          ...
          <div className="mb-6 mt-20 relative">
            <div className="w-60 h-60 mx-auto rounded-full bg-gradient-to-r from-blue-500 to-emerald-400 p-[3px] shadow-[0_0_25px_rgba(0,255,255,0.8),0_0_60px_rgba(0,255,255,0.6),0_0_90px_rgba(0,255,255,0.4)] animate-pulse">
              <img
          ...
          <div className="animate-bounce">
            <a
              href="#about"
              className="font-bold inline-flex items-center text-gray-200 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200"
            >
